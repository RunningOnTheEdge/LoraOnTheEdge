...
import main.java.home.pesehr.roadtomsc.domain.Link;
import main.java.home.pesehr.roadtomsc.domain.Node;
...
public class _Config {
    ...
    public _Config(int vnfmRam, int vnfmCores, int vnfmCapacity, int vnfmRadius, int vnfmBandwidth) {
