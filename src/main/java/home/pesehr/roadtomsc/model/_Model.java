...
import ilog.concert.*;
import main.java.home.pesehr.roadtomsc.domain.Chain;
import main.java.home.pesehr.roadtomsc.domain.Type;

*/
/**
 * _Model creates variables, objective and constraints of mathematical
...
/**
    ...
    public _Model(IloModeler modeler, Config cfg) {
...
/**
    ...
    public _Model variables() throws IloException {
        xVariable();
        yVariable();
        yHatVariable();
        zVariable();
...
/**
    ...
    public _Model objective() throws IloException {
...
/**
    ...
    public _Model constraints() throws IloException {
